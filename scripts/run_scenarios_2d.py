...
Usage
-----
Run all scenarios and display the figure interactively::#!/usr/bin/env python3
...
from viabilitykernels.phaseplane import plotallscenarios
from viabilitykernels.simulation import runscenario
from plotting.plot2d_helpers import print_summary_table
...
")
    ...
    fig = plotallscenarios(
        scenarioresults=all_results,
        par=DEFAULTPARAMS,
        bounds=DEFAULTBOUNDS,
